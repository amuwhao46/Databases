...
String[] TUPLES = {("insert into NFT(unique_name, description, nft_image, owner, creator, mint_time)" +
		"values ('Mushroom Hat', 'Lots of homies', 'photovalhold', 'bendover@gmail.com', 'bendover@gmail.com', '" + mint_time + "')," +
    		 	...
    		 	"('Fancy Unicorn','You know hes fly with his little hat','426', 'oke@gmail.com', 'oke@gmail.com', '" + mint_time + "')," +
    			"('Murky Dragonfly','This guys been flying through the desert','444', 'alf@gmail.com', 'alf@gmail.com', '" + mint_time + "')," +
